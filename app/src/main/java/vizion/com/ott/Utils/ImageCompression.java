...
/**
 * Created by dthongvl on 12/5/16.
 */
public class ImageCompression {
    private static ImageCompression ourInstance = new ImageCompression();
    ...
    public Bitmap getBitmap(Context context, Uri uri) {
        ...
        try {
            ...
            Log.d("DEBUG", "scale = " + scale + ", orig-width: " + o.outWidth + ", orig-height: " + o.outHeight);
            ...
            Log.d("DEBUG", "bitmap size - width: " + b.getWidth() + ", height: " +
                    b.getHeight());
            return b;
        } catch (IOException e) {
