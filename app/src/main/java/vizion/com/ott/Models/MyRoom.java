        ...
        if(ourInstance.isUpdate){
            if(ourInstance.currentPage<ourInstance.loadedPage)
                for(int roomIndex = 0; roomIndex<roomPage.size();roomIndex++){
                    ourInstance.listRooms.remove((ourInstance.currentPage-1)*10+roomIndex);
                    ourInstance.listRooms.add((ourInstance.currentPage-1)*10+roomIndex,roomPage.get(roomIndex));
                }
            else{
                for(int roomIndex = (ourInstance.currentPage-1)*10; roomIndex<ourInstance.listRooms.size();roomIndex++){
